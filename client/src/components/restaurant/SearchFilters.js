...
const SearchFilters = ({ filters, setFilters, onSearch, onReset }) => {
  ...
  const categories = [
    ...
    'Restaurant méditerranéen','Restaurant occidental','Restaurant surinamais-javanais','Restaurant syrien','Restaurant turc','Sandwicherie','Traiteur','Vins','Restaurant japonais', 'Steakhouse'
  ];
